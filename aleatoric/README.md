...
This is my program for the Aleatoric assignment in my Computers, Sound, and Music class at Portland State University. It generates a "song" when it is run based on a handful of chord progressions, a few tunings (equal temperaments), a range of tempos and root pitches, and random chance. The generated notes are all eighth notes and are saw waves with a linear decay that I chose to implement as an extra thing. I didn't add any of the optional things specifically listed for the assignment on Canvas but I did add some of my own extra things (like making the notes decay and doing different tuning systems as previously mentioned). Overall, there were one or more smaller issues that I was slowed down by, like getting the call to my callback function for PortAudio to use to pass compilation, but I got them figured out, and writing the program wasn't a huge challenge for me.
