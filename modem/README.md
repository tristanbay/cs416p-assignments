...
The base assignment wasn't too hard and it worked perfectly the first time I ran it after getting it to compile. I didn't do any of the extra tasks listed in the assignment, though.

The included `message.txt` is the output from the WAV file I was assigned to decode.
